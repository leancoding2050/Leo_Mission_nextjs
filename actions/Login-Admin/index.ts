...
// export const Admin_login_action = async (
//   values: z.infer<typeof Admin_Login_Schema>
// ) => {
//   console.log("--Admin_login_values-- :", values, "-- End --");
...
export const Admin_login_action = async (
  ...
  try {
    ...
    await signIn("credentials", {
      username,
      password,
      redirect: false, // 防止拋出 NEXT_REDIRECT
      role: "ADMIN", // 傳遞 role 給 auth.config.ts 的 authorize 函數
    });
