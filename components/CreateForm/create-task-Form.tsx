...
//                                     <FormControl>
//                                         <Input placeholder="school_name" value={field.value.join(", ")} readOnly />
//                                     </FormControl>
//                                     <FormMessage />
//                                 </FormItem>
//                             )}
...
//                                             <div key={job.id}>
//                                                 <p>
//                                                     code: {job.job_code}, school_name: {job.job_school_name}, subject: {job.job_subject}, area: {job.job_area}, job_time: {job.job_time_h}, day: {job.job_day.split("T")[0]}, 顯示: {job.showprice ? "顯示價格" : "隱藏價格"}
//                                                 </p>
...
//                                             <div key={d.id}>
//                                                 <p>
//                                                     code: {d.job_code}, school_name: {d.job_school_name}, subject: {d.job_subject}, area: {d.job_area}, job_time: {d.job_time_h}, day: {d.job_day.split("T")[0]}, 顯示: {d.showprice ? "顯示價格" : "隱藏價格"}
//                                                 </p>
