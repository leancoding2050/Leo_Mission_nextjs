...
const EditTaskForm = () => {
  const param = useParams();
  const targettaskId = param?.taskListsid as string;
  const useId = param?.id as string;
  const [isPending, startTransition] = useTransition();
  const [isPopupVisible, setPopupVisible] = useState(false);
  const [searchQuery, setSearchQuery] = useState("");
  const [searchResults, setSearchResults] = useState<JobData[]>([]);
  ...
  const [searchField, setSearchField] = useState("all");
  const [getTeacher, setGetTeacher] = useState<TeacherData[]>([]);
  const [GetTaskById, setGetTaskById] = useState<TaskData | null>(null);
  const [isLoading, setIsLoading] = useState(false);
  const [error, setError] = useState<string | null>(null);
    ...
    const fetchgettaskbyid = async (id: string) => {
      ...
      try {
        ...
        if (data && typeof data === "object" && "id" in data) {
          setGetTaskById(data as TaskData);
        } else {
  ...
  return (
    <div className="flex-1 sm:ml-12 md:ml-16 p-4 min-h-screen bg-gray-50 font-noto-sans-tc">
      <div className="max-w-4xl mx-auto">
        <h2 className="text-xl md:text-2xl font-bold text-primary-1 mb-6">編輯任務表單</h2>
        <Form {...task_edit_form}>
          <form onSubmit={task_edit_form.handleSubmit(task_edit_form_onSubmit)} className="space-y-6 bg-white rounded-lg shadow-sm p-6">
            <FormField
              control={task_edit_form.control}
              name="task_title"
              render={({ field }) => (
                <FormItem>
                  <FormLabel className="text-primary-1 text-sm md:text-base">任務標題</FormLabel>
                  <FormControl>
                    <Input
                      placeholder="輸入任務標題"
                      {...field}
                      disabled={isPending}
                      className="border-gray-200 focus:ring-primary-1"
                    />
                  </FormControl>
            ...
            <FormField
              ...
              render={({ field, fieldState }) => (
                <FormItem>
                  <FormLabel className="text-primary-1 text-sm md:text-base">任務科目</FormLabel>
                  <FormControl>
                    <SWR_Subject_Select_noUserSubject field={field} fieldState={fieldState} />
                  </FormControl>
                  <FormMessage className="text-red-500" />
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  <FormLabel className="text-primary-1 text-sm md:text-base">任務內容</FormLabel>
                  <FormControl>
                    <Input
                      placeholder="輸入任務內容"
                      {...field}
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  <FormLabel className="text-primary-1 text-sm md:text-base">任務編號</FormLabel>
                  <FormControl>
                    <Input
                      placeholder="輸入任務編號"
                      {...field}
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  <FormLabel className="text-primary-1 text-sm md:text-base">任務地址</FormLabel>
                  <FormControl>
                    <Input
                      placeholder="輸入任務地址"
                      {...field}
            ...
            <FormField
              ...
              render={({ field, fieldState }) => (
                <FormItem>
                  <FormLabel className="text-primary-1 text-sm md:text-base">任務地區</FormLabel>
                  <FormControl>
                    <SWR_Areas_Select field={field} fieldState={fieldState} />
                  </FormControl>
                  <FormMessage className="text-red-500" />
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  <FormLabel className="text-primary-1 text-sm md:text-base">任務價格</FormLabel>
                  <FormControl>
                    <Input
                      type="number"
                      placeholder="輸入任務價格"
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem className="flex items-center space-x-2">
                  <FormLabel className="text-primary-1 text-sm md:text-base">公開任務</FormLabel>
                  <FormControl>
                    <Switch
                      checked={field.value}
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem className="flex items-center space-x-2">
                  <FormLabel className="text-primary-1 text-sm md:text-base">顯示價格</FormLabel>
                  <FormControl>
                    <Switch
                      checked={field.value}
                      onCheckedChange={field.onChange}
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  <FormLabel className="text-primary-1 text-sm md:text-base">學校名稱</FormLabel>
                  <FormControl>
                    <Input
                      placeholder="學校名稱"
                      value={field.value.join(", ")}
            ...
            <FormField
              ...
              render={() => (
                <FormItem>
                  <FormLabel className="text-primary-1 text-sm md:text-base">任務列表</FormLabel>
                  <FormControl>
                    <Input
                      placeholder="任務列表"
                      value={selecteJobs.join(", ")}
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  <FormLabel className="text-primary-1 text-sm md:text-base">教師</FormLabel>
                  <FormControl>
                    <Select
                      value={field.value}
                      onValueChange={field.onChange}
                      disabled={isPending}
                    >
                      <SelectTrigger className="border-gray-200 focus:ring-primary-1">
                        <SelectValue placeholder="選擇教師" />
                      </SelectTrigger>
                      <SelectContent>
                        {getTeacher.map((datas) => (
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem className="flex items-center space-x-2">
                  <FormLabel className="text-primary-1 text-sm md:text-base">任務完成</FormLabel>
                  <FormControl>
                    <Switch
                      checked={field.value}
                      onCheckedChange={field.onChange}
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem className="flex items-center space-x-2">
                  <FormLabel className="text-primary-1 text-sm md:text-base">任務申請</FormLabel>
                  <FormControl>
                    <Switch
                      checked={field.value}
                      onCheckedChange={field.onChange}
            ...
            {isPopupVisible && (
              <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
                <div className="bg-white p-6 rounded-lg shadow-sm max-w-[90%] max-h-[90%] overflow-auto">
                  <div className="space-y-4">
                    <div className="flex items-center space-x-2">
                      ...
                      >
                        ...
                        <SelectContent>
                          ...
                          <SelectItem value="job_code">任務編號</SelectItem>
                          <SelectItem value="job_school_name">學校名稱</SelectItem>
                          <SelectItem value="job_subject">科目</SelectItem>
                          <SelectItem value="job_area">地區</SelectItem>
                          <SelectItem value="job_time">時間</SelectItem>
                          <SelectItem value="job_day">日期</SelectItem>
                          <SelectItem value="showprice">顯示價格</SelectItem>
                        </SelectContent>
                      </Select>
                      <Button
                        onClick={handleSearch}
                        disabled={isPending}
                        className="bg-primary-1 hover:bg-grey-2 text-white"
                      >
                        {isPending ? "搜尋中..." : "搜尋"}
                      </Button>
                    </div>
                    {searchResults.length === 0 && GetJobLists.length === 0 && (
                      <p className="text-gray-500">無可用任務</p>
                    )}
                    {searchResults.map((job) => {
                      const date = new Date(job.job_day.split('T')[0]);
                      const formattedDate = date.toLocaleDateString('en-GB', { day: '2-digit', month: '2-digit', year: 'numeric' });
                      ...
                      return (
                        <div key={job.id} className="flex items-center justify-between py-2">
                          <p className="text-gray-700">{jobDisplayString}</p>
                          <Button
                            type="button"
                    ...
                    <Button
                      onClick={handleClosePopup}
                      className="mt-4 bg-primary-1 hover:bg-grey-2 text-white"
                      disabled={isPending}
                    >
                      關閉
                    </Button>
            ...
            {selecteJobs.length > 0 && (
              <div className="mt-6">
                <p className="font-semibold text-primary-1 text-sm md:text-base">已選任務：</p>
                  ...
                  {selecteJobs.map((job, index) => (
                    <div key={index} className="flex items-center justify-between py-2">
                      ...
                      <Button
                        ...
                        disabled={isPending}
                        className="text-red-500 hover:bg-grey-2"
                      >
                        移除
                      </Button>
                    </div>
            ...
            <Button
              type="submit"
              className={`w-full bg-primary-1 hover:bg-grey-2 text-white font-semibold py-2 px-4 rounded-lg ${isPending ? "opacity-50 cursor-not-allowed" : ""}`}
              disabled={isPending}
            >
              {isPending ? "提交中..." : "提交"}
            </Button>
