...
const EditJobForm = () => {
  ...
  useEffect(() => {
    ...
    if (Job) {
      job_edit_form.setValue("userId", UserId);
      job_edit_form.setValue("targetjobId", JobId);
      job_edit_form.setValue("job_code", Job.job_code);
      job_edit_form.setValue("job_subject", Job.job_subject);
      job_edit_form.setValue("job_place", Job.job_place);
      job_edit_form.setValue("job_area", Job.job_area);
      job_edit_form.setValue("job_school_name", Job.job_school_name);
      job_edit_form.setValue("job_time", Job.job_time);
      job_edit_form.setValue("job_price", Job.job_price);
      job_edit_form.setValue("job_day", Job.job_day);
      job_edit_form.setValue("job_public", Job.job_public);
      job_edit_form.setValue("showprice", Job.show_price);
      job_edit_form.setValue("teacher", Job.teacher || "");
    }
          ...
          <FormField
            ...
            render={({ field }) => (
              <FormItem>
                ...
                <FormControl>
                  <Input placeholder="輸入工作時間" {...field} disabled={isPending} />
                </FormControl>
                <FormMessage />
              </FormItem>
            )}
